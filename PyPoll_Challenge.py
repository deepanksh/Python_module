...
file_to_load = os.path.join(r"C:\Users\deesharm\OneDrive - Microsoft\Desktop\ProjectClass\Python_module", "election_results.csv")
# Add a variable to save the file to a path.
file_to_save = os.path.join(r"C:\Users\deesharm\OneDrive - Microsoft\Desktop\ProjectClass\Python_module", "election_analysis.txt")
